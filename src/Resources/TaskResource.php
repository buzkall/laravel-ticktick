...
class TaskResource extends Resource
{
    ...
    {
        return $this->client->get("{$this->getOpenApiUrl()}/project/{$projectId}/task/{$taskId}/comments");
    }
    ...
    {
        return $this->client->post("{$this->getOpenApiUrl()}/project/{$projectId}/task/{$taskId}/comment", $data);
    }
    ...
    {
        return $this->client->delete("{$this->getOpenApiUrl()}/project/{$projectId}/task/{$taskId}/comment/{$commentId}");
    }
}
