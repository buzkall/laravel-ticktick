...
class ColumnResource extends Resource
{
    ...
    {
        return $this->client->get("{$this->getOpenApiUrl()}/project/{$projectId}/column");
    }
    ...
    {
        return $this->client->post("{$this->getOpenApiUrl()}/project/{$projectId}/column", $data);
    }
    ...
    {
        return $this->client->post("{$this->getOpenApiUrl()}/project/{$projectId}/column/{$columnId}", $data);
    }
}
