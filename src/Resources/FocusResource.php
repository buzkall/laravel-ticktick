...
class FocusResource extends Resource
{
    ...
    {
        return $this->client->get("{$this->getOpenApiUrl()}/focus/" . rawurlencode($focusId), ['type' => $type]);
    }
    ...
    {
        return $this->client->delete("{$this->getOpenApiUrl()}/focus/" . rawurlencode($focusId), ['type' => $type]);
    }
}
