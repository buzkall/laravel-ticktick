...
class HabitResource extends Resource
{
    ...
    {
        return $this->client->get("{$this->getOpenApiUrl()}/habit/" . rawurlencode($habitId));
    }
    ...
    {
        return $this->client->post("{$this->getOpenApiUrl()}/habit/" . rawurlencode($habitId), $data);
    }
    ...
    {
        return $this->client->post("{$this->getOpenApiUrl()}/habit/" . rawurlencode($habitId) . '/checkin', $data);
    }
